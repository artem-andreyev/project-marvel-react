...
const useMarvelService = () => {
    ...
    const _apiKey = "apikey=87d7f479c0a58d97ca140b36ac567f64";
    ...
    const _transformComics = (comics) => {
        return {
            ...
            price: comics.prices[0].price ? comics.prices[0].price : 'There is no information on the price of the comic book'
        }
    }
